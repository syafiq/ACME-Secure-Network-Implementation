...
//	echo $global;        
    ...
    {
//	echo "I am inside CheckLoginInDB()";
        if(!$this->DBLogin())
        {
	...
	$qry1 = "Select confirmcode from $this->tablename where username='$username'";
	$result1 = mysql_query($qry1,$this->connection);
	$row1 = mysql_fetch_array($result1);
        $pwdmd5 = md5($password.$row1['confirmcode']);
...
//	echo "over and out";        
    ...
    function InsertIntoDB(&$formvars)
    {
        ...
        $insert_query = 'insert into '.$this->tablename.'(
                ...
                "' . md5($formvars['password']. $confirmcode) . '",
                "' . $confirmcode . '"
                )';      
